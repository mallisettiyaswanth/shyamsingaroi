...
export default function MenPage() {
  return (
    <div className="min-h-screen bg-[#FDFBF7]">
      ...
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-b from-blue-50 to-transparent pt-32">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">
            Men's latest fashion
          </h1>
          <p className="text-xl text-gray-600 mb-12 text-center">
            Choose from a wide range of top choices
          </p>
...
function CategoryCard({
  ...
  return (
    <Link
      href={`/men/category/${name.toLowerCase()}`}
