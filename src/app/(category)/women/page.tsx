...
export default function WomenPage() {
  return (
    <div className="min-h-screen bg-[#FDFBF7]">
      ...
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-b from-pink-50 to-transparent pt-32">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-center bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-purple-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <CategoryCard name="Tops" itemCount={48} bgColor="bg-purple-100" />
            <CategoryCard
              name="Accessories"
              itemCount={52}
...
function CategoryCard({
  ...
  return (
    <Link
      href={`/women/category/${name.toLowerCase()}`}
  ...
  return (
    <Card className="group overflow-hidden">
      <CardContent className="p-0">
        ...
        <div className="p-4">
          <h3 className="font-semibold mb-1 group-hover:text-pink-600 transition-colors">
            {name}
          </h3>
